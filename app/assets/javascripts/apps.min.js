...
* custom function
* */
function ajaxCallForThemeChange(){
    var sidebar_gradient=$('.theme-panel-content [name=content-gradient]').val();
    var header_style=$('.theme-panel-content [name=header-styling]').val()
    var header_position=$('.theme-panel-content [name=header-fixed]').val()
    var sidebar_style=$('.theme-panel-content [name=sidebar-styling]').val()
    var sidebar_position=$('.theme-panel-content [name=sidebar-fixed]').val()
    var content_style=$('.theme-panel-content [name=content-styling]').val()
    var theme_color=$('.theme-panel-content .theme-list li.active a').data("theme")
    var sidebar_color=$('.theme-panel-content [name=sidebar-color]').val()

    $.ajax({
        url:'/theme_customizations/edit_theme',
        data: {
...
var handleSlimScroll = function () {
    ...
    $(".sidebar .nav > .has-sub > a").click(function () {
        var e = $(this).next(".sub-menu"), a = ".sidebar .nav > li.has-sub > .sub-menu", li=".sidebar .nav > li.has-sub";
...
//        }
    ...
    $("[data-click=panel-remove]").hover(function () {
        $(this).tooltip({title: "Remove", placement: "bottom", trigger: "hover", container: "body"}), $(this).tooltip("show")
        ...
        $(this).tooltip({title: "Collapse / Expand", placement: "bottom", trigger: "hover", container: "body"}), $(this).tooltip("show")
        ...
        $(this).tooltip({title: "Reload", placement: "bottom", trigger: "hover", container: "body"}), $(this).tooltip("show")
        ...
        $(this).tooltip({title: "Expand / Compress", placement: "bottom", trigger: "hover", container: "body"}), $(this).tooltip("show")
    ...
    $(e).sortable({handle: a, connectWith: t, stop: function (e, a) {
    ...
    $.cookie && $.cookie("sidebar-styling") && 0 !== $(".sidebar").length && "grid" == $.cookie("sidebar-styling") && ($(".sidebar").addClass("sidebar-grid"), $('[name=sidebar-styling] option[value="2"]').prop("selected", !0)),
        ...
        $.cookie && $.cookie("sidebar-color") && 0 !== $("#page-container").length && "lighter" == $.cookie("sidebar-color") && ($("#page-container").addClass("page-with-light-sidebar"), $('[name=sidebar-color] option[value="2"]').prop("selected", !0)),
        ...
        ajaxCallForThemeChange()
    }), $(".theme-panel [name=sidebar-color]").live("change", function () {
        2 == $(this).val() ? ($("#page-container").addClass("page-with-light-sidebar"), $.cookie("sidebar-color", "lighter")) : ($("#page-container").removeClass("page-with-light-sidebar"), $.cookie("sidebar-color", "default"))
        ajaxCallForThemeChange()
